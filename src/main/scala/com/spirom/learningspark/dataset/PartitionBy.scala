package com.spirom.learningspark.dataset
...
object PartitionBy {
  ...
  def main(args: Array[String]) {
    ...
    com.spirom.learningspark.utils.PartitionedTableHierarchy.deleteRecursively(new File(exampleRoot))
    ...
    println("*** Simple output file count: " +
      com.spirom.learningspark.utils.PartitionedTableHierarchy.countRecursively(new File(simpleRoot), ".csv"))

    com.spirom.learningspark.utils.PartitionedTableHierarchy. printRecursively(new File(simpleRoot))
    ...
    println("*** Date partitioned output file count: " +
      com.spirom.learningspark.utils.PartitionedTableHierarchy.countRecursively(new File(partitionedRoot), ".csv"))

    com.spirom.learningspark.utils.PartitionedTableHierarchy.printRecursively(new File(partitionedRoot))
    ...
    println("*** Date repartitioned output file count: " +
      com.spirom.learningspark.utils.PartitionedTableHierarchy.countRecursively(new File(repartitionedRoot), ".csv"))

    com.spirom.learningspark.utils.PartitionedTableHierarchy.printRecursively(new File(repartitionedRoot))
